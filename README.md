...
khaoslib follows [Semantic Versioning 2.0.0](https://semver.org/spec/v2.0.0.html) with specific considerations for the
Factorio modding ecosystem.

## Legal notice

khaoslib is licensed under the LGPLv3, unlike my other mods which are all licensed under the GPLv3. Mods that use
khaoslib are not required to be open source, nor are they required to be licensed under the LGPLv3. However, if you
modify khaoslib itself and distribute the modified version, you must also distribute the source code of your modified
